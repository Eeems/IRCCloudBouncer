...
module.exports = function(session){
		...
		post: function(name,data,callback,onerror){
			...
			var req = new self.Request({
				...
				headers: {
					...
					'Set-Cookie': 'session='+self.session
				},
				onerror: onerror,
				onload: function(){
	...
	module.cache.ircs.push(self);
	return self;
};
module.cache = {
	ircs: []
};
module.change_code = function(old_m,new_m,exports_o){
	new_m.cache = old_m.cache;
};